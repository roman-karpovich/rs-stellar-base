...
mod tests {
    ...
    static TEST_CASES: [TestCase; 4] = [
        ...
        TestCase {
            ...
            r#type: stellar_xdr::SignerKeyType::Ed25519SignedPayload,
        },
    ];
